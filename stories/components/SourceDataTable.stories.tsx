import { SourceDataTable, type SourceData } from "@/components/table/SourceDataTable";
...
const dataGenerator = () => {
    ...
    const statuses  = ["created", "available", "unavailable", "inconsistent_dataset"];
    ...
    const datum: SourceData = {
        ...
        relative_path: `/client${randomChoice(thousand)}/topic${randomChoice(alphabet)}/piece_${piece_number}.${ext}`,
        type: ext,
        protocol: "S3",
