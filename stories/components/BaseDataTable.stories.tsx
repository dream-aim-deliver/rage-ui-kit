...
import { BaseDataTable, type BaseDataTableProps } from "@/components/table/BaseDataTable";
...
function generateRandomPayments(count: number): PaymentExample[] {
  const statuses: PaymentExample['status'][] = ['pending', 'processing', 'success', 'failed'];
...
export const ExamplePaymentsTable: StoryObj<BaseDataTableProps<PaymentExample, unknown>> = {
    args: {
        columns: columns,
        data: data,
    },
