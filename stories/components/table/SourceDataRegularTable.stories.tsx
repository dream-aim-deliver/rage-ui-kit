...
import { SourceDataRegularTable } from "@/components/table/SourceDataRegularTable";
import { SourceDataRow } from "@/components/table/SourceDataAGGrid";

const meta: Meta = {
  title: "Components/AGGrid/SourceDataRegularTable",
  component: SourceDataRegularTable,
  parameters: {
    layout: "centered",
  },
  tags: ["autodocs"],
} satisfies Meta<typeof SourceDataRegularTable>;
