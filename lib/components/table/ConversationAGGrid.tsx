 ...
 * @param goToConversation: a function that will be called when the "Start chat" button is clicked
 * @param handleNewConversation: a function that will be called when the "New conversation" button is clicked and the title is submitted
 */
